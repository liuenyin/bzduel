---
name: premium-game-ui-vfx
description: Use this skill when the user wants to upgrade their web game UI to a "premium" feel (e.g., Honkai Star Rail style), focusing on elegant CSS animations, sophisticated color palettes, glassmorphism, and avoiding cheap/tacky web effects.
---
